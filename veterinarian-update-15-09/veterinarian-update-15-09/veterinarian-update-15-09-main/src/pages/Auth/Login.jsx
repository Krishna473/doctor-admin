...
export default function Login() {
  ...
  const onSubmit = async (values) => {
    ...
    console.log("🚀 [FRONTEND LOG] Sending Login Request Payload:", payload);
    ...
    try {
      ...
      console.error("❌ [FRONTEND LOG] Login Failed!", error);
      if (error.response) {
        console.error("❌ [FRONTEND LOG] Server returned status:", error.response.status);
        console.error("❌ [FRONTEND LOG] Server response data:", error.response.data);
      } else {
        console.error("❌ [FRONTEND LOG] Network or CORS Error (no response from server)");
      }
